...
CREATE TABLE `Property` (
  ...
  PRIMARY KEY (`ownerSsn`,`aquisitionDate`),
  CONSTRAINT `Whose_Property` FOREIGN KEY (`ownerSsn`) REFERENCES `Applicant` (`ssn`) ON DELETE NO ACTION ON UPDATE NO ACTION
