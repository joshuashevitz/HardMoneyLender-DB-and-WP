...
CREATE TABLE `Profits` (
  ...
  `grossIncome` varchar(45) DEFAULT NULL,
  `netIncome` varchar(45) GENERATED ALWAYS AS ((`grossIncome` - `loanAmount`)) VIRTUAL,
  PRIMARY KEY (`loanId`),
  CONSTRAINT `Which_Loan` FOREIGN KEY (`loanId`) REFERENCES `Loan` (`loanId`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `Profits` (`loanId`, `loanAmount`, `grossIncome`) VALUES (2,'10000','50000');
